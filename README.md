...
Create a blank workbook on Google Sheets.

Label the active worksheet tab precisely as Predictions.

Establish the database schema by populating Row 1 with these exact headers across columns A through I:
...
Deploy a new application sourcing the repository, using main as the production branch and app.py as the entrypoint.

Access Advanced Settings, navigate to the Secrets management field, and link your database via the following configuration block:
